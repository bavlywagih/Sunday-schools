...
<div>
    ...
    <form method="post" action="{{ route('post.update' , $post->id) }}" class="form-new" id="create-post-form">
        @csrf
        <div class="w-50 m-auto mt-0 " >
            <input type="hidden" name="user_id" value="{{Auth::user()->id}}">

            <textarea id="post-editor"  name="body" class="text-end" placeholder="{{Auth::user()->username}} اكتب ما تفكر فيه هنا" cols="50">{!! substr(nl2br($post->body), 0) !!}</textarea>
